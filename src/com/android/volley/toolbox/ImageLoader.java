...
public class ImageLoader {
    ...
    public static ImageListener getImageListener(final ImageView view,
            final int defaultImageResId, final int errorImageResId, final boolean shouldAnimate) {
    ...
    public ImageContainer get(String requestUrl, ImageListener imageListener,
        ...
        if (cachedBitmap != null) {
            ...
            ImageContainer container = new DefaultImageContainer(cachedBitmap, requestUrl, null, null);
        ...
        ImageContainer imageContainer =
                new DefaultImageContainer(null, requestUrl, cacheKey, imageListener);
    ...
    public class DefaultImageContainer implements ImageContainer {
         ...
         */
        public DefaultImageContainer(Bitmap bitmap, String requestUrl,
                ...
                public void run() {
                    for (BatchedImageRequest bir : mBatchedResponses.values()) {
                        for (ImageContainer container : bir.mContainers) {
                            ...
                            // skip them.
                            if (((DefaultImageContainer)container).mListener == null) {
                                continue;
                            }
                            if (bir.getError() == null) {
                                ((DefaultImageContainer)container).mBitmap = bir.mResponseBitmap;
                                ((DefaultImageContainer)container).mListener.onResponse(container, false, false);
                            } else {
                                ((DefaultImageContainer)container).mListener.onErrorResponse(bir.getError());
                            }
                        }
                    }
